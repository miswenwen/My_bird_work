...
import android.os.SystemProperties;//liuqipeng add
/**
...
public class Activity extends ContextThemeWrapper
    ...
    public void startActivityForResult(Intent intent, int requestCode, @Nullable Bundle options) {
        ...
        //liuqipeng add begin
		/*
        if(SystemProperties.get("ro.bdfun.access_control","false").equals("true")){
        	  if(intent != null && intent.getCategories()!=null && !intent.getCategories().isEmpty()){
                if(intent.getCategories().contains(Intent.CATEGORY_LAUNCHER)){
					Intent mIntent=new Intent("android.intent.action.APP_LOCK_START");
