...
public class ActivityLogMainActivity extends Activity {
	// MyView myView;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		Log.e("MainActivity", "onCreate");
		setContentView(R.layout.activitylog_activity_main);
		ActivityLogMyView myView = (ActivityLogMyView) findViewById(R.id.view);
