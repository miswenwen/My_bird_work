...
///* @ bird { add by lichengfeng for fix bug #14877 begin } */
import android.provider.Settings;
///* @ bird { add by lichengfeng for fix bug #14877 end } */
...
public class ChooseLockGeneric extends SettingsActivity {
    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        private int getResIdForFactoryResetProtectionWarningMessage() {
			//boolean hasFingerprints = mFingerprintManager.hasEnrolledFingerprints();  removed by lichengfeng from <google source code>
			///* bird @{ modified by lichengfeng 20160810 for fix bug 14877 begin }*/
            boolean hasFingerprints = mFingerprintManager.hasEnrolledFingerprints();
			if (hasFingerprints && Settings.Global.getInt(getActivity().getContentResolver(), "fingerprint_unlock",0) == 1) {
				Settings.Global.putInt(getActivity().getContentResolver(),"fingerprint_unlock", 0);
			}
			///* bird @{ modified by lichengfeng 20160810 for fix bug 14877  end }*/
            switch (mLockPatternUtils.getKeyguardStoredPasswordQuality(UserHandle.myUserId())) {
                case DevicePolicyManager.PASSWORD_QUALITY_SOMETHING:
