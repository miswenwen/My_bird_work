...
public class DateTimeSettings extends SettingsPreferenceFragment
    ...
    private static final String KEY_DATE_FORMAT = "date_format"; // BIRD_DEFAULT_DATE_FORMAT, add by peibaosheng @20160630
    ...
    // BIRD_DEFAULT_DATE_FORMAT, add by peibaosheng @20160630
    ...
    private void initUI() {
        ...
        mDateFormat = (ListPreference) findPreference(KEY_DATE_FORMAT); // BIRD_DEFAULT_DATE_FORMAT, add by peibaosheng @20160630
        if (isFirstRun) {
            getPreferenceScreen().removePreference(mTime24Pref);
            getPreferenceScreen().removePreference(mDateFormat); // BIRD_DEFAULT_DATE_FORMAT, add by peibaosheng @20160630
        }
    ...
    public void onSharedPreferenceChanged(SharedPreferences preferences, String key) {
        ...
        // BIRD_DEFAULT_DATE_FORMAT, add by peibaosheng @20160630 begin
            ...
            updateTimeAndDateDisplay(getActivity());
            /// bird: BUG #14821, add by peibaosheng @20160801 {
            getActivity().sendBroadcast(new Intent("bird.intent.action.BIRD_DATE_FORMAT_CHANGED"));
            /// @}
        }
        // BIRD_DEFAULT_DATE_FORMAT, add by peibaosheng @20160630 end
    }
