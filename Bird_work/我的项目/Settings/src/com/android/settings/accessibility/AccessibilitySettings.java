...
/*[BIRD_DIRECT_WITH_PROXIMITY] add by liuzhenting 20160718 begin*/
import com.bird.direct.*;
/*[BIRD_DIRECT_WITH_PROXIMITY] add by liuzhenting 20160718 end*/
...
public class AccessibilitySettings extends SettingsPreferenceFragment implements DialogCreatable,
    ...
    ///bird:BIRD_3P_TOUCH_SCREENSHOT_INACCESSIBILITY,liuchaofei @20160816{
    private static final String SCREENSHOT_PREFERENCE = "three_finger_printscreen";
    ///@}
    ...
    ///bird:BIRD_3P_TOUCH_SCREENSHOT_INACCESSIBILITY,liuchaofei @20160816{
    private SwitchPreference mToggleScreenShotPreference;
    ///@}
    ...
    private void initializeAllPreferences() {
        ...
        ///bird:BIRD_3P_TOUCH_SCREENSHOT_INACCESSIBILITY,liuchaofei @20160816{
        mToggleScreenShotPreference = (SwitchPreference) findPreference(SCREENSHOT_PREFERENCE);
        if (       mToggleScreenShotPreference != null
                &&BirdFeatureOption.BIRD_3P_TOUCH_SCREENSHOT_INACCESSIBILITY
                &&BirdFeatureOption.BIRD_MULTI_TOUCH
                && BirdFeatureOption.BIRD_3POINT_TOUCH_SCREENSHOT) {
            mToggleScreenShotPreference.setOnPreferenceChangeListener(this);
        }else if(mToggleScreenShotPreference != null ){
            mSystemsCategory.removePreference(mToggleScreenShotPreference);
        }
        ///@}
        ...
        if (!KeyCharacterMap.deviceHasKey(KeyEvent.KEYCODE_POWER)
				...
				|| !BirdFeatureOption.BIRD_GLOBAL_GESTURE_MENU	/// @}
        ...
        mFlipUtil = new FlipUtil(getActivity(), FlipFeature.MENU_IN_ACCESSIBILITY);
        mFlipUtil.addScreenOffIfNeeded(mSystemsCategory);
        mFlipUtil.addInCallRingMuteIfNeeded(mSystemsCategory);
        /// @}
		
		/*smart sensor,chengting,@20141103, begin*/
        if(!DirectFeature.BIRD_DIRECT_WITH_PROXIMITY){
            getPreferenceScreen().removePreference(findPreference("smart_sensor"));
        }
        /*smart sensor,chengting,@20141103, end*/
    ...
    private void updateSystemPreferences() {
        ...
        ///bird:BIRD_3P_TOUCH_SCREENSHOT_INACCESSIBILITY,liuchaofei @20160816{
        if(mToggleScreenShotPreference != null){
            mToggleScreenShotPreference.setChecked(Settings.System.getInt(getContentResolver()
                    ,"bird_three_finger_printscreen", 0) == 1);
        }
        ///@}
        // Power button ends calls.
        if (KeyCharacterMap.deviceHasKey(KeyEvent.KEYCODE_POWER)
