...
public class DashboardTileView extends FrameLayout implements View.OnClickListener {
    ...
    public DashboardTileView(Context context, AttributeSet attrs) {
        ...
        if(BirdFeatureOption.BIRD_A200_CUSTOM){
            int arrangeType = ArrangeShowSettingsDialog.getCurrentArrangeType(context);
            if(arrangeType == ArrangeShowSettingsDialog.SETTINGS_ARRANGE_TYPE_GRID)
                view = LayoutInflater.from(context).inflate(R.layout.bird_grid_dashboard_tile, this);
            else
    ...
    public void onClick(View v) {
        if(BirdFeatureOption.BIRD_A200_CUSTOM && R.string.arrange_show_settings == mTile.titleRes ){// BIRD_A200_CUSTOM add by qinzhifeng 20160415
            ArrangeShowSettingsDialog.showDialog(getContext());
            return;
        }
