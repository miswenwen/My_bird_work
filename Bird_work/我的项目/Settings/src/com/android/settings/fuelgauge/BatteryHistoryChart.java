...
public class BatteryHistoryChart extends View {
	...
	//@ {bird: modified by liuqipeng 20161105
	private String batteryPercentRemaining; 
	//@ }bird: modified by liuqipeng 20161105
    ...
    void setStats(BatteryStats stats, Intent broadcast) {
		...
		//@ {bird: modified by liuqipeng 20161105
		batteryPercentRemaining=batteryPercentString;
		//@ }bird: modified by liuqipeng 20161105
    ...
    void drawChart(Canvas canvas, int width, int height) {
		...
		//@ {bird: modified by liuqipeng 20161105
		mChargeLabelString=batteryPercentRemaining;
