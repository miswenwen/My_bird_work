...
public final class BluetoothDevicePreference extends Preference implements
    ...
    private void pair() {
        if (!mCachedDevice.startPairing()) {
            ...
            data.iconResId = BirdFeatureOption.BIRD_A200_CUSTOM ? R.drawable.bird_ic_settings_bluetooth : R.drawable.ic_settings_bluetooth;
            data.enabled = true;
    ...
    private int getBtClassDrawable() {
        ...
        return BirdFeatureOption.BIRD_A200_CUSTOM ? R.drawable.bird_ic_settings_bluetooth : R.drawable.ic_settings_bluetooth;
    }
}
