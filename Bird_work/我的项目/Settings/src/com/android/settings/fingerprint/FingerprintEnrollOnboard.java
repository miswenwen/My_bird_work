...
public class FingerprintEnrollOnboard extends FingerprintEnrollBase {
    ...
    private void launchFindSensor(byte[] token) {
		...
		android.util.Log.d("lcf_finger", "FingerprintEnrollOnboard launchFindSensor token: "+token);
		android.util.Log.d("lcf_finger", "FingerprintEnrollOnboard launchFindSensor mIntentName: "+mIntentName);
