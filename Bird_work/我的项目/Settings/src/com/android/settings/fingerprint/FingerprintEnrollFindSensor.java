...
public class FingerprintEnrollFindSensor extends FingerprintEnrollBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		android.util.Log.i("lcf_finger","FingerprintEnrollFindSensor onCreate mToken:"+mToken);
		android.util.Log.i("lcf_finger","FingerprintEnrollFindSensor onCreate mIntentName:"+mIntentName);
		android.util.Log.i("lcf_finger","FingerprintEnrollFindSensor onCreate mLaunchedConfirmLock:"+mLaunchedConfirmLock);
