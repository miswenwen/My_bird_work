...
public class FingerprintSettings extends SubSettings {
    ...
    public static class FingerprintSettingsFragment extends SettingsPreferenceFragment
        ...
        public static final String KEY_LAUNCHED_CONFIRM = "launched_confirm";
            ...
            public void handleMessage(android.os.Message msg) {
                switch (msg.what) {
                    case MSG_REFRESH_FINGERPRINT_TEMPLATES:
						...
						/*/ bird @ { removed by lichengfeng 20160713
                        updateAddPreference();
						// bird @ }*/
                        retryFingerprint();
                    break;
        ...
        public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
            ...
            v.setText(LearnMoreSpan.linkify(getText(isFingerprintDisabled()
                    ...
                    /*getString(getHelpResource()) removed by lichengfeng */"",false));
        ...
        private void addFingerprintItemPreferences(PreferenceGroup root) {
		   ...
		   // bird @} removed by lichengfeng 20160713 end */
            ...
            for(AliFingerprintUser user : mFingerprintList) {
                AliFingerprintSettingsPreference prefrence = new AliFingerprintSettingsPreference(getActivity(), user, nameList);
                mFpListGroup.addPreference(prefrence);
            }
			
            Log.d(TAG,"getActivity="+(getActivity()==null));
            AliFingerprintSettingsPreference addPreference = new AliFingerprintSettingsPreference(getActivity(), null, nameList);
        ...
        public void onResume() {
            ...
            // deleted or renamed.
			android.util.Log.i(TAG,"onResume mToken == null is "+(mToken == null)+" mLaunchedConfirm == false is "+(mLaunchedConfirm == false));
            updatePreferences();
        }
        ...
        public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference pref) {
			...
			/* removed by lichengfeng 20160713 
        ...
        public void onDestroy() {
            ...
            if (getActivity().isFinishing()) {
				...
				android.util.Log.i(TAG,"onDestroy result: "+result);
                if (result < 0) {
    ...
    private static class LearnMoreSpan extends URLSpan {
        ...
        public static CharSequence linkify(CharSequence rawText, String uri , boolean isNeedLinkify) {
