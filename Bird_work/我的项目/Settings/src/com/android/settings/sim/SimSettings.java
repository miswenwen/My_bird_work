...
import com.bird.settings.BirdFeatureOption;//add by meifangting 20150417
...
public class SimSettings extends RestrictedSettingsFragment implements Indexable,
	...
	private static final String KEY_SIMTOOLKIT_CATEGORY = "sim_toolkit_category";//add by meifangting 20150417
    private static final String KEY_SIMTOOLKIT = "sim_toolkit";//add by meifangting 20150417
    ...
    private void updateSmsValues() {
        ...
        if (simPref != null) {
            ...
            /// @}
				/// bird:BUG #13991,disable sms selection if only 1 sim insert,chengting,@20160711 {
                /*
    ...
    public void onResume() {
        ...
        */
        ...
        /// @}
		removeItem(); // add by liuchaofei for removeitem 20160718
    }
    ...
    */
    ...
    public boolean onPreferenceTreeClick(final PreferenceScreen preferenceScreen,
        ...
        if (preference instanceof SimPreference) {
            ...
            context.startActivity(intent);
        }		/*add by meifangting 20150417 begin */
        else if (findPreference(KEY_SIMTOOLKIT) == preference) {
			Intent simToolKitIntent = new Intent();
            simToolKitIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            simToolKitIntent.setClassName("com.android.stk","com.android.stk.StkMain");
            context.startActivity(simToolKitIntent);
        }
        /*add by meifangting 20150417 end */
    ...
    private boolean isDataPrefEnable() {
		...
		/// bird:BUG #13964,disable data selection if only 1 sim insert,chengting,@20160711 {
        /*
    ...
    private void removeItem() {
        /*add by meifangting 20150417 begin */
        if(!BirdFeatureOption.BIRD_SIMTOOLKIT_INSETINGS){
           PreferenceCategory mSimToolKitPreferenceCategory = (PreferenceCategory) findPreference(KEY_SIMTOOLKIT_CATEGORY);
            if(mSimToolKitPreferenceCategory!=null){
              getPreferenceScreen().removePreference(mSimToolKitPreferenceCategory);
            }
        }
        /*add by meifangting 20150417 end */
    }
