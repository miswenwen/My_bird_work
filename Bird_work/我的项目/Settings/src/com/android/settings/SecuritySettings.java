...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    private PreferenceScreen createPreferenceHierarchy() {
		...
		if (BirdFeatureOption.BIRD_ENABLE_ENCRYPTION) {
		/// @}
        ...
        if (advancedCategory != null) {
            ...
            // @ { bird ningzhiyu 20160711, remove screen pinnig
            if (BirdFeatureOption.BIRD_HIDE_SCREEN_PINNING) {
    ...
    private void maybeAddFingerprintPreference(PreferenceGroup securityCategory) {
        ...
        if (fingerprintCount > 0) {
			...
			intent.putExtra(com.android.settings.fingerprint.FingerprintEnrollBase.FINGERPRINT_INTENT_NAME, SecuritySettings.class.getName());
