...
public class AudioProfileSettings extends SettingsPreferenceFragment implements
    ...
    /*add by tianjianwei 2016/06/17 start*/
    private Intent mIntentOutDoor;
    private Intent mIntentGeneral;
    /*add by tianjianwei 2016/06/17 end*/
    private final AudioProfileListener mListener = new AudioProfileListener() {
        ...
        public void onProfileChanged(String profileKey) {
            ...
            /*add by tianjianwei 2016/06/12 start*/
            if(BirdFeatureOption.BIRD_SHOW_OUTDOORICON_IN_STAURSBAR){
                if(profileKey.equals("mtk_audioprofile_outdoor")){
                    mContext.sendBroadcast(mIntentOutDoor);   
                }else if(profileKey.equals("mtk_audioprofile_general")){
                    mContext.sendBroadcast(mIntentGeneral);
                }
            }
            /*add by tianjianwei 2016/06/12 end*/
        }
    };
    ...
    public void onCreate(Bundle icicle) {
        ...
        /*add by tianjianwei 2016/06/17 start*/
        mIntentOutDoor = new Intent("com.android.intent.AUDIO_PROFILE_OUTDOOR");
        mIntentGeneral = new Intent("com.android.intent.AUDIO_PROFILE_GENERAL");
        /*add by tianjianwei 2016/06/17 end*/
    }
