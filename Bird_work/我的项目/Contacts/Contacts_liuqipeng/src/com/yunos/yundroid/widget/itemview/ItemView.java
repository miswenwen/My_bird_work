...
public interface ItemView {
    ...
    void setIcon(String text,int textColor);
    /**
     * Set right bottom indicator on icon.
     * @param ind The indicator image.
     */
    void setRBIconIndicator(ImageView ind);
    void removeIcon();
    void showIcon();
    ImageView getIcon();
