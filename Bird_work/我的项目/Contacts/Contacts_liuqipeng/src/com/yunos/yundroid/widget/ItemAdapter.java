 ...
 */
public class ItemAdapter extends CheckedItemAdapter {
    ...
    public void add(Item item, int key) {
        item.setKey(key);
        mItems.add(item);
        addItem(item);
        initSelectedArray(mItems);
    ...
    public void updateItemId(Item item, int key) {
    ...
    public static ItemAdapter createFromXml(Context context, XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
            ...
            Item item;
            if ("text-item".equals(name)) {
                item = new TextItem();
            } else if ("separator-item".equals(name)) {
                item = new SeparatorItem();
            } else if ("drawable-item".equals(name)) {
                item = new DrawableItem();
            } else if ("subtext-item".equals(name)) {
    ...
    public long getItemId(int position) {
        int key = ((Item) getItem(position)).getKey();
        if (key != -1) {
            return key;
        } else {
            return position;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (cell == null || !item.getClass().equals(cell.getViewType())) {
            cell = item.newView(mContext, null);
            cell.prepareItemView();
            cell.setViewType(item.getClass());
        }
