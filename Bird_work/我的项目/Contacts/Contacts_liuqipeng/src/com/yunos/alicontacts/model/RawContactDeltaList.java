 ...
 */
public final class RawContactDeltaList extends ArrayList<RawContactDelta> implements Parcelable {
    ...
    public static RawContactDeltaList fromQuery(Uri entityUri, ContentResolver resolver,
        ...
        final Cursor cursor = resolver.query(entityUri, null, selection, selectionArgs, sortOrder);
        /** Cursor do not need to close. because iterator.close() will close it. */
        if (cursor != null) {
            final EntityIterator iterator = RawContacts.newEntityIterator(cursor);
        ...
        Log.e(TAG, "fromQuery cursor is null!!!");
