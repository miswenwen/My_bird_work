...
public class ContactLoader extends AsyncTaskLoader<Contact> {
    ...
    public static class ContactQuery {
        public static final String[] COLUMNS = new String[] {
                ...
                ,android.provider.ContactsContract.RawContacts.IS_SDN_CONTACT
                /// @}
        };
        ...
        ///  bird: TASK #7674,custom contacts readonly attr,chengting,@20160301 {
        public static final int INDEX_IS_SDN_CONTACT = 64;
        /// @}
    }
    ...
    private Contact loadContactEntity(ContentResolver resolver, Uri contactUri) {
        ...
        Cursor cursor = resolver.query(entityUri, ContactQuery.COLUMNS, null,
                null, Contacts.Entity.RAW_CONTACT_ID);
        if (cursor == null) {
    ...
    private void loadGroupMetaData(Contact result) {
        ...
        final Cursor cursor = getContext().getContentResolver().query(Groups.CONTENT_URI,
                GroupQuery.COLUMNS, selection.toString(), selectionArgs.toArray(new String[selectionArgs.size()]),
        ...
        for (int rawContactIndex = 0; rawContactIndex < rawContactCount; rawContactIndex++) {
            ...
            for (int dataIndex = 0; dataIndex < dataCount; dataIndex++) {
                ...
                if (dataItem instanceof PhoneDataItem) {
                    ...
                    phoneDataItem.computeFormattedPhoneNumber(getContext());
                }
            }
        }
    }
