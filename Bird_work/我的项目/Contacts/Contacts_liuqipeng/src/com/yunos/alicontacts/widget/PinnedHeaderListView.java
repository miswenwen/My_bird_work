...
public class PinnedHeaderListView extends AutoScrollListView
    ...
    private boolean mListLock = false;

    private static final int DEFAULT_ANIMATION_DURATION = 20;

    private static final int POSITION_MAX_HIT_TIMES = 3;
    ...
    public void setAdapter(ListAdapter adapter) {
        Log.i(TAG, "setAdapter: nanoTime="+System.nanoTime());
    ...
    public int getPinnedHeaderHeight(int viewIndex) {
        if (!ensurePinnedHeaderLayout(viewIndex)) {
            return 0;
        }
    ...
    private boolean ensurePinnedHeaderLayout(int viewIndex) {
        if ((mHeaders != null) && (mHeaders[viewIndex] != null)) {
            ...
            Log.e(VIEW_LOG_TAG, "ensurePinnedHeaderLayout("+viewIndex+") mHeaders is NULL!");
            return false;
        }
    }
    ...
    public int getPositionAt(int y) {
        ...
        do {
            ...
            // a nearby pixel
            y++;
        } while (++ hitTime < POSITION_MAX_HIT_TIMES);
        return 0;
    }
    ...
    public  void lockListMove(boolean lock) {
        mListLock = lock;
     }
}
