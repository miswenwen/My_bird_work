...
public final class ContactLoaderUtils {
    ...
    public static Uri ensureIsContactUri(final ContentResolver resolver, final Uri uri)
        ...
        if (ContactsContract.AUTHORITY.equals(authority)) {
            ...
            throw new IllegalArgumentException("uri format is unknown! uri:" + uri + ", type:" + type);
        }
        ...
        throw new IllegalArgumentException("uri authority is unknown, authority:" + authority);
    }
}
