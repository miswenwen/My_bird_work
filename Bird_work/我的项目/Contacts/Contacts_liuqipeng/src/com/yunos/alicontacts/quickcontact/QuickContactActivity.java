...
import com.yunos.alicontacts.util.ImageViewDrawableSetter;
import com.yunos.alicontacts.util.SchedulingUtils;
import com.yunos.alicontacts.util.StopWatch;
...
import yunos.support.v4.view.ViewPager.SimpleOnPageChangeListener;
...
public class QuickContactActivity extends FragmentActivity {
    ...
    // YUNOS BEGIN PB
    // ##modules(Contacts): ##author:guoshuai.lgs
    // ##BugID:(6406968) ##date:2015/09/16
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mContactLoader = (ContactLoader) getSupportLoaderManager().initLoader(
    ...
    private void bindData(Contact data) {
        ...
        // ##modules(Contacts): ##author:guoshuai.lgs
        // ##BugID:(6406968) ##date:2015/09/16
        // ##description: notify data changed when mSortedActionMimeTypes data is changed.
