...
public abstract class IndexerListAdapter extends PinnedHeaderListAdapter implements SectionIndexer {
    ...
    protected boolean mIsShowFavoriteContacts = false;
    protected int mFavoriteContactsOffset;
    ...
    public HashMap<String, Integer> getSectionMap() {
    	...
    	HashMap<String, Integer> mSectionMap = new HashMap<String, Integer>();
     	String[] section = (String[])getSections();

     	int position = 0;
     	for(int i=0;i < section.length;i++) {
     	    int sectionPosition = mIndexer.getPositionForSection(i);
     	    if(sectionPosition != -1) {    	    	
     	    	position = sectionPosition;
     	    	mSectionMap.put(section[i], position);
     	    }
