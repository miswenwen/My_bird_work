...
public abstract class AccountType {
    ...
    /** Local account and YunOS account */
    public static final String LOCAL_ACCOUNT_TYPE = "Local Phone Account";
    public static final String LOCAL_ACCOUNT_NAME = "Phone";
    public static final String YUNOS_ACCOUNT_TYPE = "com.aliyun.tyid";
    ...
    private volatile boolean mKindsSorted = false;
