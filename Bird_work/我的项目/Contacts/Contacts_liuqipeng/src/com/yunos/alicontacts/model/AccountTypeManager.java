...
import com.yunos.alicontacts.model.account.ExchangeAccountType;
import com.yunos.alicontacts.model.account.ExternalAccountType;
import com.yunos.alicontacts.model.account.FallbackAccountType;
    ...
    protected void loadAccountsInBackground() {
        ...
        try {
            ...
            for (SyncAdapterType sync : syncs) {
                ...
                } else if (FallbackAccountType.YUNOS_ACCOUNT_TYPE.equals(type)) {
                    /**
                     * if account type is YunOS account "com.aliyun.tyid", we
                     * think it's default account type, not external account
                     * type.
                     */
                    accountType = new FallbackAccountType(mContext, auth.packageName);
                } else {
            ...
            Log.e(TAG, "loadAccountsInBackground Exception", e);
        }
