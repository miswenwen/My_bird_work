...
public final class ContactsPreferences extends ContentObserver {
    ...
    public int getSortOrder() {
        ...
        if (mSortOrder == -1) {
            mSortOrder = Settings.System.getInt(mContext.getContentResolver(), SORT_ORDER_KEY,
                    getDefaultSortOrder());
        }
        return mSortOrder;
    }
    ...
    public void setSortOrder(int sortOrder) {
        ...
        Settings.System.putInt(mContext.getContentResolver(), SORT_ORDER_KEY, sortOrder);
    }
    ...
    public int getDisplayOrder() {
        ...
        if (mDisplayOrder == -1) {
            mDisplayOrder = Settings.System.getInt(mContext.getContentResolver(), DISPLAY_ORDER_KEY,
    ...
    public void setDisplayOrder(int displayOrder) {
        ...
        Settings.System.putInt(mContext.getContentResolver(), DISPLAY_ORDER_KEY, displayOrder);
    }
    ...
    public void registerChangeListener(ChangeListener listener) {
        ...
        contentResolver.registerContentObserver(
                Settings.System.getUriFor(SORT_ORDER_KEY), false, this);
        contentResolver.registerContentObserver(
                Settings.System.getUriFor(DISPLAY_ORDER_KEY), false, this);
    }
