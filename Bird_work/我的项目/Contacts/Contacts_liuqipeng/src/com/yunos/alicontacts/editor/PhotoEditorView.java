...
public class PhotoEditorView extends FrameLayout implements Editor {
    ...
    public void setValues(DataKind kind, ValuesDelta values, RawContactDelta state, boolean readOnly,
        ...
        if (values != null) {
            ...
            if (photoBytes != null) {
                final Bitmap photo = BitmapUtil.circleMaskBitmap(BitmapFactory.decodeByteArray(photoBytes, 0,
                        photoBytes.length));
    ...
    public void setPhotoBitmap(Bitmap photo) {
        ...
        mPhotoImageView.setImageBitmap(BitmapUtil.circleMaskBitmap(photo));
        mFrameView.setEnabled(isEnabled());
        mHasSetPhoto = true;
        mEntry.setFromTemplate(false);
    ...
    protected void resetDefault() {
        ...
        //mPhotoImageView.setImageResource(R.drawable.contact_header_avatar_border_acquiesce);
