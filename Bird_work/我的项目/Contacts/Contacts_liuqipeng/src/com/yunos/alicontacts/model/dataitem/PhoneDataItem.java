...
public class PhoneDataItem extends DataItem {
    ...
    public void computeFormattedPhoneNumber(Context context) {
        final String phoneNumber = getNumber();
        if (phoneNumber != null) {
            final String formattedPhoneNumber = ContactsUtils.formatPhoneNumberWithCurrentCountryIso(phoneNumber, context);
