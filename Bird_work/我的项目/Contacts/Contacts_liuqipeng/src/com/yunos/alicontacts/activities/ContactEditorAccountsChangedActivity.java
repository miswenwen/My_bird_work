...
import com.yunos.alicontacts.editor.ContactEditorUtils;
...
public class ContactEditorAccountsChangedActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (numAccounts >= 2) {
        	...
        	setActivityContentView(R.layout.contact_editor_accounts_changed_activity_with_picker);
        	...
        	setActivityContentView(R.layout.contact_editor_accounts_changed_activity_with_text);
    ...
    private void saveAccountAndReturnResult(AccountWithDataSet account) {
        ...
        intent.putExtra(PDConstants.INTENTS_INSERT_EXTRA_ACCOUNT, account);
