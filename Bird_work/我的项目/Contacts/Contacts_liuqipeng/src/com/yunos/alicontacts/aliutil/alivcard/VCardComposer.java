...
public class VCardComposer {
    ...
    static {
        ...
        sImMap.put(Im.PROTOCOL_WANGWANG, VCardConstants.PROPERTY_X_WANGWANG);
    ...
    //##BugID:(8466294) ##date:2016-2-2 09:00
    ...
    public boolean initWithRawContactsEntityUri(Uri contentUriForRawContactsEntity) {
        return init(Contacts.CONTENT_URI, CONTACTS_PROJECTION, null, null, null,
    ...
    public boolean init(final String selection, final String[] selectionArgs) {
        return init(Contacts.CONTENT_URI, CONTACTS_PROJECTION, selection, selectionArgs,
                null, null);
    }
    ...
    public boolean init(final Uri contentUri, final String selection,
        ...
        return init(contentUri, CONTACTS_PROJECTION, selection, selectionArgs, sortOrder, null);
    }
    ...
    public boolean init(final Uri contentUri, final String selection,
        ...
        return init(contentUri, CONTACTS_PROJECTION, selection, selectionArgs, sortOrder,
                contentUriForRawContactsEntity);
    }
    ...
    //##BugID:(8466294) ##date:2016-2-2 09:00
    //##description:suppot export some contacts to vcard
    public void initIds(String contactIds) {
    ...
    public String preInit() {
        ...
        Cursor cursor = null;
        try {
            cursor = mContentResolver.query(RawContacts.CONTENT_URI, CONTACTS_PROJECTION, RawContacts.DELETED
                    + "=0 AND (" + RawContacts.ACCOUNT_TYPE + "='" + AccountType.LOCAL_ACCOUNT_TYPE + "' OR "
                    + RawContacts.ACCOUNT_TYPE + "='" + AccountType.YUNOS_ACCOUNT_TYPE + "')", null, null);
            if (cursor != null) {
            ...
            Log.e(LOG_TAG, "preInit() Exception", e);
        } finally {
            if (cursor != null) {
                cursor.close();
            }
    ...
    //##description:suppot export some contacts to vcard
    public String preInitExtend() {
        String selection = null;
        StringBuilder sb = new StringBuilder();
        Cursor cursor = null;
        try {
            selection = RawContacts.DELETED
                    + "=0 AND " + RawContacts.CONTACT_ID + " in " + mContactIds ;
            cursor = mContentResolver.query(RawContacts.CONTENT_URI, CONTACTS_PROJECTION, selection, null, null);
