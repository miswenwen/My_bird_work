...
import com.yunos.alicontacts.editor.EventFieldEditorView;
import com.yunos.alicontacts.editor.PhoneticNameEditorView;
...
import com.yunos.alicontacts.util.NameConverter;
...
public class RawContactModifier {
    ...
    private static void parseValues(
        ...
        for (ContentValues values : dataValueList) {
            ...
            if ((kind.typeOverallMax != 1) || GroupMembership.CONTENT_ITEM_TYPE.equals(mimeType)) {
                ...
                //
                // Original Code respect the typeOverallMax of each kind;
                // Here we add exception for GroupMembership Kind,
                // Because of the requirement of DuplicateRemove Plugin,
                // which want to insert multiple Groupship for one new contact editor
    ...
    private static void fixupLegacyImType(Bundle bundle) {
        ...
        try {
            ...
            Log.e(TAG, "fixupLegacyImType throw IllegalArgumentException", e);
        }
    }
