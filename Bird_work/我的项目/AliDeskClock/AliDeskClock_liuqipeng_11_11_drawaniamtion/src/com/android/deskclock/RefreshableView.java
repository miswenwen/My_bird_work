...
public class RefreshableView extends LinearLayout implements OnTouchListener, AlarmListView.ListViewMoveListener {
    ...
    public RefreshableView(Context context, AttributeSet attrs) {
        super(context, attrs);
        //header = new SearchView(context);
		header = LayoutInflater.from(context).inflate(R.layout.main_alarm_frame, null, true);
