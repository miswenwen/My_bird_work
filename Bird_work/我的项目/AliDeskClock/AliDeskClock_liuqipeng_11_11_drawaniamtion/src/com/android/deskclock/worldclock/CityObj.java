...
public class CityObj {
    ...
    //private static final String CITY_DRAWABLE_ID = "city_drawableId_id_";
    ...
    public CityObj(SharedPreferences prefs, int index) {
        ...
        //mDrawableId = prefs.getInt(CITY_DRAWABLE_ID + index, 0);
    }
    ...
    public void saveCityToSharedPrefs(SharedPreferences.Editor editor, int index) {
        ...
        //editor.putInt (CITY_DRAWABLE_ID + index, mDrawableId);
    }
}
