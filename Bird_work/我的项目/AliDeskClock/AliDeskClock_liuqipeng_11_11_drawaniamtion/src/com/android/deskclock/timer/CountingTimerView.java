...
public class CountingTimerView extends View {
    ...
    private final Paint mPaintSmallThin = new Paint();
    private final Paint mPaintMed = new Paint();
    private final float mBigFontSize, mBigFontSize2, mSmallFontSize;
    ...
    public CountingTimerView(Context context, AttributeSet attrs) {
        ...
        mLightGreyColor = r.getColor(R.color.stopwatch_text);
        mDefaultColor =  r.getColor(R.color.stopwatch_text_default);//Color.parseColor("#646464");
        ...
        mBigFontSize2 = r.getDimension(R.dimen.big_font_size2);
        ...
        Typeface dinpro = Typeface.createFromAsset(context.getAssets(), "fonts/DINPro/DINPro-Light.otf");
        mPaintBigThin.setAntiAlias(true);
        mPaintBigThin.setStyle(Paint.Style.STROKE);
        mPaintBigThin.setTextAlign(Paint.Align.CENTER);
        mPaintBigThin.setTypeface(dinpro);

        Typeface dinpro1 = Typeface.createFromAsset(context.getAssets(), "fonts/DINPro/DINPro-Light.otf");
        mPaintSmallThin.setAntiAlias(true);
        mPaintSmallThin.setStyle(Paint.Style.STROKE);
        mPaintSmallThin.setTextAlign(Paint.Align.CENTER);
        mPaintSmallThin.setTypeface(dinpro1);
        ...
        mMedHundredths = new Hundredths(mPaintSmallThin, HUNDREDTHS_SPACING, allDigits);
    ...
    protected void resetTextSize() {
        ...
        mPaintBigThin.setFakeBoldText(true);
//liuqipeng begin
        //mPaintSmallThin.setTextSize(mBigFontSize2);
		mPaintSmallThin.setTextSize(mBigFontSize);
//liuqipeng
        mPaintSmallThin.setFakeBoldText(true);
        mPaintMed.setTextSize(mSmallFontSize);
    }

    protected void setTextColor(int textColor) {
        mPaintBigThin.setColor(textColor);
        mPaintSmallThin.setColor(textColor);
    ...
    public void setTime(long time, boolean showHundredths, boolean update) {
        ...
        if (minutes >= 10 || hours > 0) {
            ...
            format = format + ":";
            mMinutes = String.format(format, minutes);
            //TODO penglei: fix the format of the stopwatch
...
/*            // If the hypotenuse of the bounding box is too large, reduce all the paint text sizes
    ...
    public void redTimeStr(boolean red, boolean forceUpdate) {
        mDefaultColor = red ? mRedColor : getContext().getResources().getColor(R.color.stopwatch_text_default);//Color.parseColor("#646464");
        setTextColor(mDefaultColor);
        if (forceUpdate) {
            invalidate();
        }
    ...
    private void virtualButtonPressed(boolean pressedOn) {
        ...
        //mStopStartTextView.setTextColor(pressedOn ? mPressedColor : mLightGreyColor);
        invalidate();
    }
