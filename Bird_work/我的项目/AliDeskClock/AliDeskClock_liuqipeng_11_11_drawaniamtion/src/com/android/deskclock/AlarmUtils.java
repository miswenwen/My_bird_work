...
public class AlarmUtils {
    ...
    public static String getFormattedTime(Context context, Calendar time) {
        ...
        if (AlarmFeatureOption.YUNOS_MTK_PLATFORM) {
            ...
            pattern = "EEE kk:mm";
            Log.i("getBestDateTimePattern for pattern alarmUtil" + pattern);
        }
    ...
    public static void showTimeEditDialog(Context context, FragmentManager manager, final Alarm alarm,
        ...
        TimePickerDialog dialog = new TimePickerDialog(context, listener, hour, minutes, is24HourMode);
        dialog.setButton(AlertDialog.BUTTON_NEGATIVE, context.getResources().getString(R.string.add_alarm_page_cacnel), new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
            }
        });
        
        dialog.setButton(AlertDialog.BUTTON_POSITIVE, context.getResources().getString(R.string.add_alarm_page_confirm), dialog);
    ...
    public static void showTimeEditDialog(Context context, FragmentManager manager, int hour, int minutes,
            TimePickerDialog.OnTimeSetListener listener, boolean is24HourMode, final SetGroupView setGroupView) {
        TimePickerDialog dialog = new TimePickerDialog(context, listener, hour, minutes, is24HourMode);
        dialog.setButton(AlertDialog.BUTTON_NEGATIVE, context.getResources().getString(R.string.add_alarm_page_cacnel), new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                setGroupView.setFromTimePickNow = false;
                dialog.dismiss();
            }
        });
        
        dialog.setButton(AlertDialog.BUTTON_POSITIVE, context.getResources().getString(R.string.add_alarm_page_confirm), new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                setGroupView.setFromTimePickNow = true;
                dialog.dismiss();
            }
        });
        DialogUtils.fromBottomToTop(dialog);
