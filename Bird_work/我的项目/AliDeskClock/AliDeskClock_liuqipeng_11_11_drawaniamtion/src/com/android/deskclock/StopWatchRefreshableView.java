...
public class StopWatchRefreshableView extends LinearLayout implements OnTouchListener, AlarmListView.ListViewMoveListener{
...
//liuqipeng
    ...
    private AlarmListView mCommonList;
     ...
     * @param attrs
     */
    public StopWatchRefreshableView(Context context, AttributeSet attrs) {
        super(context, attrs);
        header = LayoutInflater.from(context).inflate(R.layout.main_stopwatch_frame, null, true);
...
//liuqipeng begin
			...
			//mydistance=(int)20*density;
			mydistance=60;
            hideHeaderHeight = -header.getHeight()+mydistance;
...
//liuqipeng
            ...
            headerLayoutParams.topMargin = 0;
//liuqipeng
            mDragView = (View)getChildAt(1);
            mDragView.setOnTouchListener(this);
            mCommonList = (AlarmListView) getChildAt(3);
...
//liuqipeng begin 
			...
			//mListPaddingTop = mCommonList.getPaddingTop()+60;
//liuqipeng 
            loadOnce = true;
        }
    }
    ...
    private void setIsAbleToPull(MotionEvent event) {
        ...
        if (firstChild != null) {
            ...
            if (mDisPlayTwoItem) {
                ...
                if (firstVisiblePos == 0 && firstChild.getTop() >= mListPaddingTop && distance >= 0) {
                    //if (firstVisiblePos == 0) {
                        if (!ableToPull) {
                            yDown = event.getRawY();
                        }
...
//liuqipeng
		...
		//float x=(headerLayoutParams.topMargin-60)/header.getHeight();
		//headerLayoutParams.topMargin = (int)(60*(1-x)+margin;
//liuqipeng
...
//liuqipeng
            headerLayoutParams.topMargin = 0;
			//headerLayoutParams.topMargin = 60;
//liuqipeng 
        } else {
//liuqipeng begin
			//headerLayoutParams.topMargin = header.getHeight();
            headerLayoutParams.topMargin = mydistance-header.getHeight();
//liuqipeng
        }
        header.setLayoutParams(headerLayoutParams);
    }
