...
public final class AlarmNotifications {
    ...
    public static void broadcastNextAlarm(Context context, AlarmInstance instance)  {
        ...
        if (instance != null) {
            ...
            showStatusIcon = true;
            timeInMillis = instance.getAlarmTime().getTimeInMillis();
        }
        ...
        Settings.System.putString(context.getContentResolver(),
                ...
                timeString);
        Settings.System.putLong(context.getContentResolver(), "next_alarm", timeInMillis);
        Intent alarmChanged = new Intent(SYSTEM_ALARM_CHANGE_ACTION);
        alarmChanged.putExtra("alarmSet", showStatusIcon);
        if(timeInMillis > 0)
            alarmChanged.putExtra("alarmTime", timeInMillis);
    ...
    public static void showHighPriorityNotification(Context context, AlarmInstance instance) {
        ...
        Notification.Builder notification = new Notification.Builder(context)
                ...
                .setContentText(AlarmUtils.getAlarmText(context, instance))
                .setSmallIcon(R.drawable.stat_notify_alarm)
                .setLargeIcon(BitmapFactory.decodeResource(resources,R.drawable.clock_alarm_notification))
                //.setOngoing(true)
                .setAutoCancel(true)
    ...
    public static void showSnoozeNotification(Context context, AlarmInstance instance) {
        Log.v("Utils.sHideNotification - showSnoozeNotification = "+Utils.sHideNotification);
        if (Utils.sHideNotification) {
            return;
        }
        ...
        RemoteViews notificationView = new RemoteViews(context.getPackageName(),
                R.layout.alarm_notification_view);

        notificationView.setTextViewText(R.id.alarmclock_label, instance.getLabelOrDefault(context));
        notificationView.setTextViewText(R.id.alarmtime_label, resources.getString(R.string.alarm_alert_snooze_until,
        ...
        notificationView.setOnClickPendingIntent(R.id.offalarm, PendingIntent.getBroadcast(context, instance.hashCode(),
                       dismissIntent, PendingIntent.FLAG_UPDATE_CURRENT));
    ...
    public static void showMissedNotification(Context context, AlarmInstance instance) {
        ...
        Log.v("Utils.sHideNotification  - showMissedNotification = "+Utils.sHideNotification);
        if (Utils.sHideNotification) {
            return;
        }
        NotificationManager nm = (NotificationManager)
        ...
        Notification.Builder notification = new Notification.Builder(context)
                ...
                .setSmallIcon(R.drawable.stat_notify_alarm)
                .setLargeIcon(BitmapFactory.decodeResource(context.getResources(),R.drawable.clock_alarm_notification))
                .setPriority(Notification.PRIORITY_HIGH);
