...
public class StopwatchService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.d(TAG,"StopwatchService - actionType = "+actionType+", actionTime = "+actionTime+", mStartTime = "+mStartTime
                +", mElapsedTime = "+mElapsedTime+", mNumLaps = "+mNumLaps);
        if (actionType.equals(Stopwatches.START_STOPWATCH)) {
            ...
            Log.d(TAG, "Stopwatches.SHOW_NOTIF - mStartTime = "+mStartTime);
            if (mStartTime == 0 || !showSavedNotification()) {
                stopSelf();
            }
    ...
    private void setNotification(long clockBaseTime, boolean clockRunning, int numLaps) {
        Log.d(TAG,"StopwatchService - setNotification clockBaseTime = "+clockBaseTime+", clockRunning = "+clockRunning+", numLaps = "+numLaps);
        ...
        RemoteViews remoteViewsCollapsed = new RemoteViews(getPackageName(),
                R.layout.stopwatch_notification_view);
        ...
        //        setImageViewResource(R.id.notification_icon, R.drawable.clock_timer_notification);
...
*/
        ...
        remoteViewsCollapsed.setOnClickPendingIntent(R.id.stopwatch,
        ...
        if (clockRunning) {
            ...
            if (numLaps > 0) {
                String lapText = String.format(
                        context.getString(R.string.sw_notification_lap_number), numLaps+1);
                remoteViewsCollapsed.setTextViewText(R.id.alarmtime_label, lapText);
                remoteViewsCollapsed.setViewVisibility(R.id.alarmtime_label, View.VISIBLE);
                ...
                remoteViewsCollapsed.setViewVisibility(R.id.alarmtime_label, View.GONE);
            ...
            remoteViewsExpanded.setViewVisibility(R.id.swn_expanded_laps, View.VISIBLE);*/
            remoteViewsCollapsed.setTextViewText(R.id.alarmtime_label, getString(R.string.swn_stopped));
            remoteViewsCollapsed.setViewVisibility(R.id.alarmtime_label, View.VISIBLE);
        }
    ...
    private void saveNotification(long clockTime, boolean clockRunning, int numLaps) {
        Log.d(TAG,"StopwatchService - saveNotification clockTime = "+clockTime+", clockRunning = "+clockRunning+", numLaps = "+numLaps);
    ...
    private boolean showSavedNotification() {
        ...
        Log.d(TAG,"clockBaseTime = "+clockBaseTime+", numLaps = "+numLaps+", clockElapsedTime = "+clockElapsedTime+
    ...
    private void closeNotificationShade() {
        Log.d(TAG,"closeNotificationShade");
    ...
    private void readFromSharedPrefs() {
        ...
        Log.d(TAG,"mStartTime = "+mStartTime+", mElapsedTime = "+mElapsedTime+", mNumLaps = "+mNumLaps);
    }
    ...
    private void writeToSharedPrefs(Long startTime, Long lapTimeElapsed, Long elapsedTime,
        ...
        Log.d(TAG,"writeToSharedPrefs - startTime = "+startTime+", lapTimeElapsed = "+lapTimeElapsed+", elapsedTime = "+elapsedTime
                +", state = "+state+", updateCircle = "+updateCircle);
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(
                getApplicationContext());
        SharedPreferences.Editor editor = prefs.edit();
        if (startTime != null) {
    ...
    private void writeSharedPrefsStarted(long startTime, boolean updateCircle) {
        Log.d(TAG,"writeSharedPrefsStarted - startTime = "+startTime+", updateCircle = "+updateCircle);
