...
public class WorldMyAnalogClock extends AnalogClock implements Handler.Callback {
...
//liuqipeng
    ...
    public WorldMyAnalogClock(Context context) {
        this(context, null);
    }

    public WorldMyAnalogClock(Context context, AttributeSet attrs, int defStyle) {
    ...
    public WorldMyAnalogClock(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
...
//liuqipeng
		...
		mWorldNum=mRes.getDrawable(R.drawable.clock_worldclock_number);
...
/*aihua.shenah remove seconds,becasue of issues of performance.*/
    ...
    protected void onDraw(Canvas canvas) {
        ...
        dial.draw(canvas);
//liuqipeng
    	final Drawable worldNum = mWorldNum;
        int ww = worldNum.getIntrinsicWidth();
        int hh = worldNum.getIntrinsicHeight();
/*
...
*/
        if (changed) {
            worldNum.setBounds(x - (ww / 2), y - (hh / 2), x + (ww / 2), y + (hh / 2));
        }
        worldNum.draw(canvas);
//liuqipeng
        canvas.save();
...
//liuqipeng
        ...
        /*aihua.shenah remove seconds,becasue of issues of performance.*/
        // canvas.rotate(mWorkSecond / 60000.0f * 360.0f, x, y);
...
*/
//liuqipeng
        final Drawable dot = mDot;
        w = dot.getIntrinsicWidth();
        h = dot.getIntrinsicHeight();
        //Log.i(TAG, "dot w:" + w + " h:" + h);
        dot.setBounds(x - (w / 2), y - (h / 2), x + (w / 2), y + (h / 2));
        dot.draw(canvas);
