...
public class DelTrackChoiceActivity extends ListActivity implements
	...
	//@ {bid:add by fanglongxiang 20170315
	...
	//@ {bird:dele by fanglongxiang 20170315-remove menu}
    /*@Override
    ...
    private void initializeViews() {
        ...
        all.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                mAdapter.notifyDataSetChanged();
                //invalidateOptionsMenu();//fanglongxiang-remove menu
				updateBottomBtns();//fanglongxiang 20170315
            }
        });
        btnCheckAll = (Button) findViewById(R.id.btn_checkall);
        btnCheckAll.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
				android.util.Log.d("flx", "btn click");
    ...
    public void init(Cursor newCursor, boolean isLimited) {
        ...
        if (mTrackCursor == null) {
            ...
            btnCheckAll.setEnabled(true);//fanglongxiang false->true
            btnCheckAll.setClickable(true);
