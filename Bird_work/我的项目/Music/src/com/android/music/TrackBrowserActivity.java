        ...
        implements View.OnCreateContextMenuListener, MusicUtils.Defs, ServiceConnection
{
	...
	private int mCountTime = 0; //add by fanglongxiang
    ...
    public void onCreate(Bundle icicle)
    {
        ...
        if (mEditMode) {
			...
			//@ {bird: modify by fanglongxiang 20170308 true2false}
    ...
    public boolean onContextItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case SHARE:
                ...
                return true;
        //add by wangye for music share @20y160919,end
        }
        //SPRD 476978
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (mPlaylist != null) {
            ...
            /* SPRD bug fix 548581,541220@{ */
            if (AddMusicForCMCC.getInstance().isCMCCVersion() && !mPlaylist.equals("podcasts")
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if(mPlaylist!=null && !mPlaylist.equals("nowplaying") && !mPlaylist.equals("podcasts")
            ...
            if(item != null) {
				//@ {bird:modify by fanglongxiang 20170317}
				mCountTime = 0;
				setDeleMenuEnale(item);
	...
	//@ {bird:add by fanglongxiang 20170317
	private void setDeleMenuEnale(MenuItem item) {
		if(mTrackCursor == null && mCountTime < 100) {
			mCountTime++;
			final MenuItem menuItem = item;
			new Handler().postDelayed(new Runnable(){   
				public void run() {   
					setDeleMenuEnale(menuItem);
				}   
			 }, 150);   
			return;
		}
    ...
    private Cursor getTrackCursor(TrackListAdapter.TrackQueryHandler queryhandler, String filter,
        ...
        if (mGenre != null) {
            ...
            if (mPlaylist.equals("nowplaying")) {
				...
				//@ {bird: add by fanglongxiang 20170314
