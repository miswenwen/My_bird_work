...
public class MusicBrowserActivity extends Activity
    ...
    public void onCreate(Bundle icicle) {
		...
		//@ {bird:add by fanglongxiang 20170311
        Intent mediaScanIntent = new Intent("android.intent.action.MyselfScanMedia");
    ...
    private void activateTab() {
		//@ {bird: modify by fanglongxiang 20170307
        if(true) {
			MusicUtils.activateTab(this, R.id.playlisttab);
		} else {
			int activeTab = MusicUtils.getIntPref(this, "activetab", R.id.artisttab);
		    if (activeTab != R.id.artisttab
		            && activeTab != R.id.albumtab
