    ...
    implements View.OnCreateContextMenuListener, MusicUtils.Defs
{
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.removeItem(R.id.search);//fanglongxiang
          /* @} */
        if (!mCreateShortcut) {
        ...
        // SPRD 476973
		//@ {bird: add by fanglongxiang 20170307
		menu.add(0, SCAN_MUSIC, 0, R.string.scan_music);
		//@ }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
			...
			//@ {bird:add by fanglongxiang 20170307
			case SCAN_MUSIC:
				/*String[] paths = new String[]{android.os.Environment.getExternalStorageDirectory().toString()+"/Music"};  
    			android.media.MediaScannerConnection.scanFile(this, paths, new String[]{"audio/*"}, 
					new android.media.MediaScannerConnection.OnScanCompletedListener(){
						@Override
						public void onScanCompleted (String path, Uri uri) {
							android.util.Log.d("flx", "path="+path+";uri="+uri);
						}
					});*/
            ...
            + android.os.Environment.getExternalStorageDirectory())));*/
				...
				Intent mediaScanIntent = new Intent(
                            "android.intent.action.MyselfScanMedia");
                sendBroadcast(mediaScanIntent);
