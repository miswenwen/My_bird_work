...
import com.bird.music.BirdFeatureOption;//add by wangye for music share 20160919
    ...
    View.OnTouchListener, View.OnLongClickListener, LRC.PositionProvider
{
    ...
    /* SPRD 476974 @{ */
	//liuqipeng add 3.28
	private ImageButton mVolumeRaise;
	private ImageButton mVolumeLower;
	private AudioManager mAudio;
	private boolean mAlbumAnimationStart=true;
	private Animation mAnimation;
	private ValueAnimator mAnimator;
	private float mCurrentRotateValue=0;
	//liuqipeng end 3.28
    ...
    //SPRD bug fix 585063
    private boolean mIs_Registered = false;
    /* @} */
    /* SPRD 476972 @{ */
    ...
    public void onCreate(Bundle icicle)
    {
		...
		actionbar.hide();//liuqipeng add 3.28
        /* @} */
		...
		//liuqipeng add 3.28
		mVolumeRaise=(ImageButton)findViewById(R.id.volumn_plus);
		mVolumeLower=(ImageButton)findViewById(R.id.volumn_sub);
		mAudio=(AudioManager) getSystemService(Service.AUDIO_SERVICE);
		//liuqipeng end 3.28
		
		//@ {bird:add by fanglongxiang 20170316
		if(true) {
			mShuffleButton.setFocusable(false);
			mRepeatButton.setFocusable(false);
			mQueueButton.setFocusable(false);
		}        
		//@ }
    ...
    public void onStop() {
        ...
        /* SPRD bug fix 585063 @{ */
        if (mIs_Registered && mStatusListener != null) {
            unregisterReceiver(mStatusListener);
            mIs_Registered = false;
        }
        /* @} */
...
//liuqipeng add 3.28
	public void startAlbumRotateAnimator(){
		try{
...
//liuqipeng end 3.28
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        /* @} */
			...
			menu.removeItem(EFFECTS_PANEL);//@ {bird:add by fanglongxiang remove EFFECTS_PANEL}
            return true;
        /* SPRD 476972 @{ */
        //}
        //return false;
        ...
        try {
            switch(keyCode)
            {
				...
				case KeyEvent.KEYCODE_DPAD_DOWN:
					mVolumeLower.setPressed(false);
					return true;
				case KeyEvent.KEYCODE_DPAD_UP:
					mVolumeRaise.setPressed(false);
					return true;
				//liuqipeng end 3.28
            }
        } catch (RemoteException ex) {
...
*/
			...
			//liuqipeng add 3.28
			case KeyEvent.KEYCODE_DPAD_DOWN:
				mVolumeLower.setPressed(true);
				mAudio.adjustStreamVolume(
				    AudioManager.STREAM_MUSIC,
				    AudioManager.ADJUST_LOWER,
				    AudioManager.FLAG_PLAY_SOUND | AudioManager.FLAG_SHOW_UI);
				return true;
			case KeyEvent.KEYCODE_DPAD_UP:
				mVolumeRaise.setPressed(true);
				mAudio.adjustStreamVolume(
				    AudioManager.STREAM_MUSIC,
...
//liuqipeng end  3.28  
    public class AlbumArtHandler extends Handler {
        ...
        public void handleMessage(Message msg)
        {
            ...
            if (msg.what == GET_ALBUM_ART && (mAlbumId != albumid || albumid < 0)) {
                ...
                if (bm != null) {
					//liuqipeng change 3.28
                    //numsg = mHandler.obtainMessage(ALBUM_ART_DECODED, bm);
					numsg = mHandler.obtainMessage(ALBUM_ART_DECODED, toRoundBitmap(bm));
					//liuqipeng end 3.28
                    mHandler.removeMessages(ALBUM_ART_DECODED);
    ...
    private void initlrcViews() {
		...
		mList.setFocusable(false);//fanglongxiang
    }
