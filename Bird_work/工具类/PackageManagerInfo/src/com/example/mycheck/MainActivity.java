...
public class MainActivity extends Activity {
	...
	private List<AppInfo> appInfos1=new ArrayList<AppInfo>(); //use in search()
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new MyAdapter(MainActivity.this, R.layout.appinfo_item,
				appInfos);
...
//		appInfos.clear();
	...
	public void getDesktopApp() throws NameNotFoundException {// //apps with icon on desktop--packagename / classname
		...
		for (ResolveInfo reInfo : resolveInfos) {
			...
			AppInfo appInfo = new AppInfo(appLabel, appIcon, pkgName,
					className, sourceDir);
			appInfos.add(appInfo); 
			i++;
		}
